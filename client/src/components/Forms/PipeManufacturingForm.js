    ...
    const handleSubmit = (e) => {
        ...
        /*if (param.id) {
            handleOpenDialog({
                ...
                buttons: [
                    { lable: "Update", navigatePage: "/LCADatas", onConfirm: () => { dispatch(updatePost(param.id, Object.assign(infoData, calculationData))) } },
                    //{ lable: "Update and go Calculations", navigatePage: "/LCADatas", onConfirm: () => { dispatch(updatePost(param.id, Object.assign(infoData, calculationData))) } },
                    //{ lable: "Update and stay in form", onConfirm: () => { dispatch(updatePost(param.id, Object.assign(infoData, calculationData))) } }
                ]
            })
        } else {
            handleOpenDialog({
